...
@ApiModel(value = "Instuctor",
          description = "The Instructor Entity")
@Entity
@Table(name = "instructor")
public class Instructor
{
    @ApiModelProperty(name = "instructid",
                      value = "Primary Key for Instructor Entity",
                      required = true,
                      example = "1")
    @Id
    ...
    @ApiModelProperty(name="instructname", value="Instructor's Name", example="John")
